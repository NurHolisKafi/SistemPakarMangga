...
class DetailHama extends StatefulWidget {
  int? id;
  DetailHama(this.id, {super.key});

  @override
  // ignore: no_logic_in_create_state
  State<DetailHama> createState() => _DetailHamaState(id);
}

class _DetailHamaState extends TimeoutMixin<DetailHama> {
  YoutubePlayerController? _controller;
  int? id;

  _DetailHamaState(this.id);
  @override
  void initState() {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ListView.builder(
              itemCount: snapshot.data!.penanganan!.length,
              shrinkWrap: true,
              physics: NeverScrollableScrollPhysics(),
              itemBuilder: (context, index) {
                return content(toBeginningOfSentenceCase(
                        snapshot.data!.penanganan![index].nama) ??
                    '');
              },
            ),
            const SizedBox(
